...
public class NotificationUtils {
    ...
    public static final int ACTION_DRINK_PENDING_INTENT_ID = 22;

    //  COMPLETE (1) Create a method to clear all notifications

    public static void clearAllNtification(Context context){
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        Intent ignoreRemaindIntent = new Intent(context, WaterReminderIntentService.class);
        //      COMPLETE (7) Set the action of the intent to designate you want to dismiss the notification
        ignoreRemaindIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
        //      COMPLETE (8) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent ignoreRemaiderPendingIntent = PendingIntent.getService(context,
...
//      COMPLETE (12) Create an Intent to launch WaterReminderIntentService
        ...
        PendingIntent incrementWaterPendingntent = PendingIntent.getService(
                context,
        ...
        NotificationCompat.Action drinkWaterAction = new NotificationCompat.Action(
                R.drawable.ic_local_drink_black_24px,"I did it!",incrementWaterPendingntent);
