...
public class ReminderUtilities {
    ...
    public static final int SYNC_FLEXTIME_SECONDS = (int) TimeUnit.MINUTES.toSeconds(REMINDER_INTERVAL_SECONDS);
    ...
    synchronized public static void scheduleChargingReminder (final Context context){
        ...
        Job constraitReminderJob = dispatcher.newJobBuilder()
        ...
        dispatcher.schedule(constraitReminderJob);
