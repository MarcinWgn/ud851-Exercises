...
public class NotificationUtils {
    public static final int REQUEST_CODE_ID = 233;
    public static final String NOTIFICATION_CHANNEL_ID = "reminder_notification";
    ...
    public static void remindUserBecauseCharging (Context context){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            channel = new NotificationChannel(NOTIFICATION_CHANNEL_ID,
                    context.getString(R.string.main_notifiction_channel_name),
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context,
                NOTIFICATION_CHANNEL_ID).setColor(ContextCompat.getColor(context,R.color.colorPrimary))
                .setSmallIcon(R.drawable.ic_drink_notification)
                .setLargeIcon(largeIcon(context))
                .setContentText(context.getString(R.string.charging_reminder_notification_body))
                .setStyle(new NotificationCompat.BigTextStyle().bigText(
                context.getText(R.string.charging_reminder_notification_body)))
        ...
        manager.notify(REQUEST_CODE_ID,builder.build());
    }
    ...
    private static PendingIntent contentIntent (Context context){
        ...
        return PendingIntent.getActivity(context,
                REQUEST_CODE_ID,intent,PendingIntent.FLAG_UPDATE_CURRENT);
    }
